...
local n, s, b, t = "num", "str", "bool", "table"
local typemap = { byte = n, char = n, short = n, int = n, long = n, float = n, double = n, integer = n,
	...
	vector = t, list = t, deque = t, hashset = t, treeset = t, linkedhashset = t, array = t, arraydeque = t,
	arraylist = t, linkedlist = t, set = t, linkedset = t, hashmap = t, treemap = t, linkedhashmap = t, map = t, linkedmap = t, }
