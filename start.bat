...
set LIB=lib/slf4j-api-1.7.7.jar;lib/log4j-core-2.0.jar;lib/log4j-api-2.0.jar;lib/log4j-slf4j-impl-2.0.jar;lib/mina-core-2.0-head-20140512.jar;lib/luaj-jse-2.0.3.jar
