...
public final class Const
{
	...
	static
	{
		String sas_prop = null;
		try
		{
			sas_prop = System.getProperty("sas.prop");
			sas_prop = (sas_prop != null ? sas_prop.trim() : "sas.properties");
			Log.log.debug("{}: load {}", Const.class.getName(), sas_prop);
			_property.load(new FileInputStream(sas_prop));
		}
		catch(Exception e)
		{
			Log.log.warn("{}: load {} failed, use all default properties", Const.class.getName(), sas_prop);
		}
