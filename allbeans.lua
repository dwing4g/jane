...
bean{ name="TestBean", type=1, initsize=16, maxsize=16, extend=true, comment="bean的注释",
...
dbt { name="Benchmark", id=3, lock="bench", key="id", value="TestBean", comment="用于测试数据库的表. cachesize不定义或<=0则靠软引用的生命期决定(内存表则不限制大小)" }
